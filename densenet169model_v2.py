...
filepath = '/scratch/ttc290/kiet/densenet169model_v2_120epoch/accuracy_{val_categorical_accuracy:.10f}.hdf5'
...
with open(os.path.join('/home/ttc290/kiet', 'densenet169_v2_120epoch.json'), 'w') as f:
