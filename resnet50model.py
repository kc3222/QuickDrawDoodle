...
pretrained_model = ResNet50(weights='imagenet', include_top=True, input_tensor=common_layer, classes=1000)
...
filepath = '/scratch/ttc290/kiet/resnet50model_10epoch/accuracy_{val_categorical_accuracy:.10f}.hdf5'
...
with open(os.path.join('/home/ttc290/kiet', 'resnet50model_120epoch.json'), 'w') as f:
